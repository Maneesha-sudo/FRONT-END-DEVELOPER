...
useState for state and UI management

useEffect for handling side effects (localStorage)
...
Lifting state up and prop-based communication
...
TodoInput – Handles task creation

TodoList – Filters, sorts, and displays tasks

TodoItem – Manages individual task actions (edit, delete, complete)

Filter – Filters tasks based on status

DarkModeToggle – Toggles dark and light theme
